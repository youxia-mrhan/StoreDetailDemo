 ...
 * 扩展 NavigatorHelper
 */
public class NavigatorHelperEx {
    ...
    private OnNavigatorExScrollListener mNavigatorScrollListener;
    ...
    private void dispatchOnSelected(int index) {
        if (mNavigatorScrollListener != null) {
            ...
            mNavigatorScrollListener.onSelected(index, mTotalCount, getmLastIndex());
        }
    ...
    public void setNavigatorScrollListener(OnNavigatorExScrollListener navigatorScrollListener) {
    ...
    public interface OnNavigatorExScrollListener {
        ...
        void onSelected(int index, int totalCount, int previousIndex);
